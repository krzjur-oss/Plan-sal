...
- Zaleca się regularne tworzenie kopii zapasowych danych za pomocą funkcji **Eksportuj JSON** (Menu ☰ → ⬆ Eksportuj JSON).
...
Wszelkie pytania dotyczące Aplikacji lub niniejszego Regulaminu można kierować do Autora za pośrednictwem repozytorium GitHub projektu: **https://github.com/krzjur-oss/Plan-sal**
