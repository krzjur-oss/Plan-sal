...
const CACHE = 'sp-v' + APP_VERSION; // v2.6.0 WF slot model + teacher/class edit + collision fixes // v2.5.9 support teacher + editable teacher/class view // v2.5.8 collision detection fix
const ASSETS = [
  './',
  './index.html',
  './app.js',
