...
export function openWizardNewYear() {
  ...
  if (appState) {
    // Wstępnie wypełnij z bieżącego roku
    const { setWBuildings, setWFloors, setWSubjects, setWTimeslots } = await import('./state.js').catch(() => ({}));
    // inline: używamy setterów zaimportowanych z state.js na górze modułu
  }
